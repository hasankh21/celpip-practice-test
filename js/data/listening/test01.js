// Listening Practice Test 1 — original content modeled on the official CELPIP-General format
...
Marcus: Sounds good. Let's aim to have this settled by end of day today so nobody shows up confused on Friday.`,
        questions: [
          ...
          {
            q: "How did Dana first discover the double booking?",
            options: [
              "Marcus told her about it.",
              "She noticed two entries on the room calendar while printing the sign-in sheet.",
              "The client complained.",
              "Facilities emailed her about it.",
            ],
            correct: 1,
            explain:
              "Dana says she only noticed when she went to print the sign-in sheet and saw the room calendar had two entries.",
          },
          {
            q: "How many people does the Elm Street room normally seat?",
            options: ["Eight", "Ten", "Twelve", "Twenty"],
            correct: 2,
            explain: "Marcus confirms the Elm Street room seats twelve.",
          },
          {
            q: "By when does Marcus want the room situation settled?",
            options: [
              "By the end of the day today",
              "By Thursday morning",
              "By Friday at noon",
              "He doesn't give a deadline",
            ],
            correct: 0,
            explain:
              "Marcus's final line says he wants this settled by end of day today so nobody shows up confused on Friday.",
          },
        ],
      },
      {
...
Librarian: Of course, welcome again, and don't hesitate to call if you have more questions.`,
        questions: [
          ...
          },
          {
            ...
            correct: 2,
            explain: "The librarian states one card works at all six branches across the city.",
          },
          {
          ...
          {
            q: "On what day of the month are the adult programs held?",
            options: [
            ...
            correct: 0,
            explain:
              "The librarian says the book club, workshops, and computer classes are held at the downtown branch on the first Tuesday of every month.",
          },
        ],
      },
      {
        ...
        questions: [
          ...
          {
            q: "How large is the lot being converted?",
            options: ["Half an acre", "Two acres", "Ten acres", "It isn't stated"],
            correct: 1,
            explain: "The report describes it as a two-acre space.",
          },
          {
            q: "How many plots will the space be divided into?",
            options: ["Six", "Sixteen", "Sixty", "Six hundred"],
            correct: 2,
            explain: "The report says the space will be divided into sixty individual plots.",
          },
        ],
      },
      {
...
Wei: Same. I just hope they actually measure whether it's working instead of just assuming more office time automatically means better results.`,
        questions: [
          ...
          {
            q: "According to Wei, what has his cousin experienced in a fully remote job?",
            options: [
              "She got promoted quickly.",
              "She still doesn't really know her coworkers.",
              "She quit after a week.",
              "She prefers it to office work.",
            ],
            correct: 1,
            explain:
              "Wei mentions his cousin started a fully remote job and said she still doesn't really know her coworkers.",
          },
          {
            q: "According to Alicia, what is hard to replicate remotely?",
            options: [
              "Answering emails",
              "Mentorship and picking up tips from watching someone work nearby",
              "Scheduling meetings",
              "Using video conferencing software",
            ],
            correct: 1,
            explain:
              "Alicia says mentorship and picking up small tips from watching someone work nearby are hard to replicate remotely.",
          },
          {
            q: "What does Alicia wonder about regarding the three office days?",
            options: [
              "Whether the policy will be cancelled",
              "Whether there will be flexibility on which days, or if they're fixed for everyone",
              "Whether she will be fired",
              "Whether the office will move locations",
            ],
            correct: 1,
            explain:
              "Alicia wonders aloud whether the company will offer flexibility on which three days, or if it's fixed for everyone.",
          },
        ],
      },
      {
