// CELPIP-style Reading practice content (original material, modeled on the official test format).

const readingData = {
  title: "Reading",
  totalSuggestedMinutes: 55,
  parts: [
    {
      id: "r1",
      partLabel: "Part 1",
      ...
      instructions:
        "Read the email below, then read the reply. Some words in the reply are missing. Choose the best option to fill each numbered blank.",
      suggestedMinutes: 15,
...
Heather Nolan
Building Manager`,
      replyTitle: "Reply (fill in the blanks)",
      replyTemplate: [
        "Dear Ms. Nolan,",
        ...
        "Finally, I noticed the notice didn't mention whether the elevator maintenance is ___(4)___ to happen again later this year, since we had similar work done back in the spring.",
        "I appreciate the ___(5)___ you've given us, and I understand maintenance is sometimes unavoidable.",
        "Sincerely,",
      ...
      blanks: [
        ...
        },
        {
          ...
          correct: 0,
          explain:
            "The question is about whether the single elevator can manage the increased number of people using it — \"handle\" means to cope with or manage a load, which fits the context of extra traffic.",
        },
        {
          num: 3,
          ...
          correct: 1,
          explain:
            "Tomas is asking for help carrying his delivery since he can't use the stairs easily — \"assist\" (help) matches the building staff's stated role of helping residents during the maintenance period.",
        },
        {
          num: 4,
...
if (typeof module !== "undefined") module.exports = readingData;
