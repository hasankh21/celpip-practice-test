// CELPIP-style Speaking practice content (original material, modeled on the official test format).
// Speaking is free-response; the "answer key" is a sample response plus notes on what makes it strong.

const speakingData = {
  title: "Speaking",
  totalSuggestedMinutes: 17,
  tasks: [
    {
      id: "s1",
      partLabel: "Task 1",
...
if (typeof module !== "undefined") module.exports = speakingData;
