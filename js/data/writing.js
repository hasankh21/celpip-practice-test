// CELPIP-style Writing practice content (original material, modeled on the official test format).
...
Given these two issues, I would like to request a full replacement in the correct walnut finish, with a undamaged top panel, shipped at no additional cost. If a replacement will take longer than two weeks, I would appreciate the option of a full refund instead.
...
if (typeof module !== "undefined") module.exports = writingData;
